...
;------------------------------------------------------------------------------------------------------------------
; Begin main procedure that guides the program through the other procedures.
.code      
...
;------------------------------------------------------------------------------------------------------------------
;Print myName in edx, print to screen.
...
;------------------------------------------------------------------------------------------------------------------
;Put prompt into edx, print to screen, repeat with prompt4.
